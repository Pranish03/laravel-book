    ...
    <div class="py-4 px-4">
        ...
        <div class="mt-8 flex flex-col gap-2 text-lg">
            <a href="{{ route('dashboard') }}"
                ...
                {{ request()->routeIs('dashboard') ? 'text-slate-700 bg-slate-100' : 'text-zinc-800' }}">
            ...
            <a href=""
                class="font-medium hover:text-slate-700 hover:bg-slate-200 py-2 px-4 rounded-md flex items-center gap-3
                {{ request()->routeIs('') ? 'text-slate-700 bg-slate-100' : 'text-zinc-800' }}">
            ...
            <a href="{{ route('admin.books.index') }}"
                class="font-medium hover:text-slate-700 hover:bg-slate-200 py-2 px-4 rounded-md flex items-center gap-3
                {{ request()->routeIs('admin.books.*') ? 'text-slate-700 bg-slate-100' : 'text-zinc-800' }}">
